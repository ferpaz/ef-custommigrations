...
namespace EFCustomMigrationOperations
{
    public class CustomMigrationSqlGenerator : SqlServerMigrationSqlGenerator
    {
        protected override void Generate(MigrationOperation migrationOperation)
        {
            ...
            {
                Generate((CreateCheckConstraintOperation)migrationOperation);
            }
            else if (migrationOperation is DropCheckConstraintOperation)
            {
                Generate((DropCheckConstraintOperation)migrationOperation);
            }
            else if (migrationOperation is CreateDefaultConstraintOperation)
            {
